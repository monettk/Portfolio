...
```{r}
states <- read_csv(here("data", "states.csv"), show_col_types = FALSE)
rest <- read_csv(here("data", "FastFoodRestaurants.csv"), col_types = cols(address = col_skip(), keys = col_skip(), websites = col_skip()), show_col_types = FALSE) %>%
